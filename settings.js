...
global.owner = process.env.OWNER_NUMBER  || '94775228949' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=CN1iybzK#25hevPtouTQOPVQzpIwLB_gyroZcaIPT5cFTWx6nRYY' ,
